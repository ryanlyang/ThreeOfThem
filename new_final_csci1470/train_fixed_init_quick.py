...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    ...
    p.add_argument("--fixed-init-vel-jitter-std", type=float, default=0.006)
    ...
    p.add_argument("--w-near-collision", type=float, default=8.0)
